...
/**
 * Classify a set of content blocking events for a single origin into a
 * TrackingDBService type ID. Returns null or OTHER_COOKIES_BLOCKED_ID (0)
 * when the origin should not be counted toward the blocked total.
 * Returns undefined if there is no blocking event, or OTHER_COOKIES_BLOCKED_ID (0) if it is a
 * cookie which is not a tracking cookie.
 *
