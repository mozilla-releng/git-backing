...
///////////////////////////////////////////////////////////////////////////////
// The actual coordinates. The parser can decode a position; reducing it to a
// yes/no for a privacy-sensitive use is the caller's job, not the parser's.
///////////////////////////////////////////////////////////////////////////////
...
// SRATIONAL coordinates are not permitted by any edition of the specification,
// but AOSP's Camera2 writer emits them. See IsToleratedCoordinateType.
...
// The tolerance stops at the coordinates. DJI writes GPSAltitude as SRATIONAL
// with genuinely negative values, which would need real signed handling.
