 ...
 *
 * Positions here count every slot a screen reader can land on, including non-tab slots such as
 * the tab group onboarding card. Reordering works in tab list indices instead - see
 * [TabReorderGeometry].
 *
...
internal data class TabCollectionSemantics(
    ...
    fun itemInfo(position: Int, columnSpan: Int = 1) = CollectionItemInfo(
